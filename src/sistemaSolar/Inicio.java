...
public class Inicio {
    ...
    //static Planeta planetas[] = new Planeta[5];
    ...
    public static void menu(){
        ...
        System.out.println("Modificar Planeta [4]");
        System.out.println("Eliminar un planeta [5]");
        System.out.println("salir [0]");
    }

    public static void CrearPlaneta(Planeta planetas[]){
    ...
    public static void BuscarPlaneta(Planeta planetas[]){
    ...
    public static void ModificarPlaneta(Planeta planetas[]){
    ...
    public static void EncontrarPlaneta(Planeta planetas[]){
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    CrearPlaneta(planetas);
                    break;
                case 2:
                    MostrarPlanetas(planetas);
                    break;
                case 3:
                    BuscarPlaneta(planetas);
                    break;
                case 4 :
                    ModificarPlaneta(planetas);
                    break;
                case 5 :
                    EncontrarPlaneta(planetas);
                    break;
                case 0:
