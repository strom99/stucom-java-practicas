...
public class Inicio {
    public static void main(String[] args) {
        ...
        Persona per1 = new Persona("lola","menea",'M', 32);
        System.out.println(per1);
        Empleado per2 = new Empleado("renold", "mename",'M',23,1,1222);
...
/*        String nombrep = "frank";
        ...
        //SETTERS -> establece la edad que le manda el usuario , y get lo muestra
    }
}
